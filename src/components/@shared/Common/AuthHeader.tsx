...
export default function AuthHeader() {
  ...
  return (
    <Flex className="fixed left-0 right-0 top-0 z-50 h-[60px] min-w-[300px] items-center justify-end border-b-[1px] border-border-gray bg-white pl-[84px] pr-3 md:h-[70px] md:px-10 md:pl-[200px] md:pr-10 xl:px-[70px] xl:pl-[340px] xl:pr-20">
      <HeaderTitle />
      {dashboardid && (
        <>
