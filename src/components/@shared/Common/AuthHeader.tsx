...
export default function AuthHeader() {
  ...
  return (
    <Flex className="fixed left-0 right-0 top-0 z-50 h-[60px] min-w-[300px] items-center justify-end border-b-[1px] border-border-gray bg-white pl-[84px] pr-3 dark:bg-black-600 md:h-[70px] md:px-10 md:pl-[200px] md:pr-10 xl:px-[70px] xl:pl-[340px] xl:pr-20">
      <HeaderTitle />
      {dashboardid && (
        <>
          <Group className="shrink-0 gap-[6px] font-md-14px-medium">
            <LinkButton
              ...
              className="flex items-center dark:border-gray-400 dark:text-gray-300 md:gap-2"
            >
            ...
            <HeaderInviteModal opened={opened} onClose={close}>
              <button
                ...
                className="flex items-center rounded-lg border border-border-gray bg-transparent px-3 py-[3px] text-gray-400 hover:bg-gray-200 dark:border-gray-400 dark:text-gray-300 md:gap-2 md:px-4 md:py-[6px]"
              >
                <Rotate className="flex">
                  <Image
                    className="hidden md:inline"
